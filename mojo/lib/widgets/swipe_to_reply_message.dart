...
class SwipeToReplyMessage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final dragController = useScrollController();
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Text('Replying to ${message.userId}'),
              ],
            ),
                  ...
                  Positioned.fill(
                    child: Container(
                      margin: EdgeInsets.only(
                        left: isOwnMessage ? 0 : 50,
                        right: isOwnMessage ? 50 : 0,
                      ),
